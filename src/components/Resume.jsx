...
import { FiDownload, FiExternalLink, FiHome, FiFolder, FiUser } from 'react-icons/fi';
...
const Resume = ({ setActiveSection }) => {
  ...
  return (
      ...
      <div className="resume-content">
        <div className="resume-section">
          ...
          <div className="resume-item">
            ...
            <p className="resume-meta">B K Birla Institute of Engineering & Technology, Pilani, Rajasthan</p>
            <p className="resume-description">
              Currently pursuing Bachelor of Technology in Computer Science with focus on web development, 
    ...
    </div><div className="view-all-section">
